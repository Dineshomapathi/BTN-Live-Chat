...
<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.3/css/bootstrap.min.css'><link href="{{ asset('css/style.css') }}" rel="stylesheet">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        ...
        <p>The booth you are looking for does not exist.
          How you got here is a mystery.
        </p>
        <!-- <button onClick="javascript:window.close('','_parent','');" class="btn green">CLOSE</button> -->
      </div>
    </div>
  </div>
</main>
<!-- partial -->
  <script src='https://cdnjs.cloudflare.com/ajax/libs/gsap/3.1.1/gsap.min.js'></script><script src="{{ asset('js/script.js') }}" defer></script>
